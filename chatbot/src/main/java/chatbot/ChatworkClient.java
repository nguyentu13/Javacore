...
public class ChatworkClient {
    ...
    private static final String CW_API_TOKEN = "ccc365a1593cf3eaef6d45d96ae7b8d3"; //Replace your ChatWork API Token
     ...
     */
    private static final String CB_API_KEY = "k1kmNWsPx3jYZRCaElUMKkQrmcVlFmRM+JRFyJFn";  //Replace your Simsimi API Key
    private static final String CB_API_URL = "http://sandbox.api.simsimi.com/request.p?key=%KEY%&lc=en&ft=0.0&text=%TEXT%";
    private static final String BOT_ID = "[To:4440409]"; //Replace XXXXX to ID ChatWork of Bot
