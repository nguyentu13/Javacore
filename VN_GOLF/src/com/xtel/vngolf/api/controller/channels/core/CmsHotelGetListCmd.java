...
public class CmsHotelGetListCmd extends AbsApiBaseParamReqTypeCmd{
	...
	public CmsHotelGetListCmd(HttpServletRequest httpServletRequest, String channel, String transid) {
		super(httpServletRequest, channel, transid);
	}

	@Override
	protected void executeCmd() throws Exception {
		DbCmsHotelGetListCmd dbCmd = new DbCmsHotelGetListCmd(transid,channel);
		executeDbCmd(dbCmd);
		setResponse(dbCmd.getCode(),dbCmd.getMessage(),dbCmd.getList());
	}
